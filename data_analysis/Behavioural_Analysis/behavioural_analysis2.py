...
idx = behvaioural_df_complete.query('alpha<=360').index
#behvaioural_df_alpha.loc[idx, 'valid'] = 'yes'
behvaioural_df_complete[behvaioural_df_complete.valid == 'yes']
behvaioural_df_complete.valid.isna().sum()-behvaioural_df_complete.alpha.isna().sum()
